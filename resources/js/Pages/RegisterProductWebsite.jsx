                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    {/* <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg"> */}
                        ...
                        <div className="flex items-center mb-8 container max-auto">
                            <PlusButton classname="flex items-center justify-center w-8 h-8 bg-blue-600 text-white aspect-square hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300"/>
                        </div>
